...
-- at runtime using the environment variable quic_bindir.
...
-- environment variable quic_libdir.
...
-- using the environment variable quic_dynlibdir.
...
-- runtime using the environment variable quic_datadir.
...
-- using the environment variable quic_sysconfdir.
...
bindir     = "/home/jules/.cabal/bin"
libdir     = "/home/jules/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/quic-0.3.1-inplace"
dynlibdir  = "/home/jules/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/jules/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/quic-0.3.1"
libexecdir = "/home/jules/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/quic-0.3.1"
sysconfdir = "/home/jules/.cabal/etc"

getBinDir     = catchIO (getEnv "quic_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "quic_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "quic_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "quic_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "quic_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "quic_sysconfdir") (\_ -> return sysconfdir)
